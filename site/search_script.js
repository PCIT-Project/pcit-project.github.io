...
const search_targets = [
	...
	new SearchTarget("Builtin Module @config", "/site/documentation/panther/intrinsics/builtin_module_config.html", "Documentation for the builtin module @config in the Panther programming language", ["builtin","module","@config"], [0,4]),
	new SearchTarget("Builtin Module @options", "/site/documentation/panther/intrinsics/builtin_module_options.html", "Documentation for the builtin module @options in the Panther programming language", ["builtin","module","@options"], [0,4]),
	...
	new SearchTarget("@comptimePrint", "/site/documentation/panther/intrinsics/comptimePrint.html", "Print to console at compile time", ["@comptimeprint"], [0,4]),
	new SearchTarget("@comptimePrintln", "/site/documentation/panther/intrinsics/comptimePrintln.html", "Print to console at compile time", ["@comptimeprintln"], [0,4]),
	new SearchTarget("@createPantherBuild", "/site/documentation/panther/intrinsics/createPantherBuild.html", "Create a Panther Build in the build-system", ["@createpantherbuild"], [0,4]),
	...
	new SearchTarget("@entry", "/site/documentation/panther/intrinsics/entry.html", "Direclty call the entry function", ["@entry"], [0,4]),
	...
	new SearchTarget("@isComptime", "/site/documentation/panther/intrinsics/isComptime.html", "Get if currently in comptime scope", ["@iscomptime"], [0,4]),
	...
	new SearchTarget("@panic", "/site/documentation/panther/intrinsics/panic.html", "Direclty call the panic handler", ["@panic"], [0,4]),
	...
	new SearchTarget("@build.PantherBuildConfig", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfig", "", ["@build.pantherbuildconfig"], [0,4]),
	new SearchTarget("@build.BuildOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildOutput", "", ["@build.buildoutput"], [0,4]),
	new SearchTarget("@build.BuildExecutableOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildExecutableOutput", "", ["@build.buildexecutableoutput"], [0,4]),
	new SearchTarget("@build.BuildObjectOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildObjectOutput", "", ["@build.buildobjectoutput"], [0,4]),
	new SearchTarget("@build.BuildAssemblyOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildAssemblyOutput", "", ["@build.buildassemblyoutput"], [0,4]),
	new SearchTarget("@build.BuildLLVMIROutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildLLVMIROutput", "", ["@build.buildllvmiroutput"], [0,4]),
	new SearchTarget("@build.BuildPIROutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildPIROutput", "", ["@build.buildpiroutput"], [0,4]),
	new SearchTarget("@build.BuildASTOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildASTOutput", "", ["@build.buildastoutput"], [0,4]),
	new SearchTarget("@build.BuildTokensOutput", "documentation/panther/intrinsics/builtin_module_build.html#BuildTokensOutput", "", ["@build.buildtokensoutput"], [0,4]),
	new SearchTarget("@build.PantherPackage", "documentation/panther/intrinsics/builtin_module_build.html#PantherPackage", "", ["@build.pantherpackage"], [0,4]),
	new SearchTarget("@build.PackageOption", "documentation/panther/intrinsics/builtin_module_build.html#PackageOption", "", ["@build.packageoption"], [0,4]),
	new SearchTarget("@build.PackageOptionValue", "documentation/panther/intrinsics/builtin_module_build.html#PackageOptionValue", "", ["@build.packageoptionvalue"], [0,4]),
	new SearchTarget("@build.PantherDirectory", "documentation/panther/intrinsics/builtin_module_build.html#PantherDirectory", "", ["@build.pantherdirectory"], [0,4]),
	new SearchTarget("@build.CFamilyHeader", "documentation/panther/intrinsics/builtin_module_build.html#CFamilyHeader", "", ["@build.cfamilyheader"], [0,4]),
	...
	new SearchTarget("@config.architecture", "documentation/panther/intrinsics/builtin_module_config.html#architecture", "", ["@config.architecture"], [0,4]),
	new SearchTarget("@config.platform", "documentation/panther/intrinsics/builtin_module_config.html#platform", "", ["@config.platform"], [0,4]),
	new SearchTarget("@config.mode", "documentation/panther/intrinsics/builtin_module_config.html#mode", "", ["@config.mode"], [0,4]),
	new SearchTarget("@config.compilerMode", "documentation/panther/intrinsics/builtin_module_config.html#compilerMode", "", ["@config.compilermode"], [0,4]),
	new SearchTarget("@config.windowsSubsystem", "documentation/panther/intrinsics/builtin_module_config.html#windowsSubsystem", "", ["@config.windowssubsystem"], [0,4]),
	new SearchTarget("@config.optMode", "documentation/panther/intrinsics/builtin_module_config.html#optMode", "", ["@config.optmode"], [0,4]),
	new SearchTarget("@config.includeDebugInfo", "documentation/panther/intrinsics/builtin_module_config.html#includeDebugInfo", "", ["@config.includedebuginfo"], [0,4]),
	new SearchTarget("@pthr.Architecture", "documentation/panther/intrinsics/builtin_module_pthr.html#Architecture", "", ["@pthr.architecture"], [0,4]),
	new SearchTarget("@pthr.Platform", "documentation/panther/intrinsics/builtin_module_pthr.html#Platform", "", ["@pthr.platform"], [0,4]),
	new SearchTarget("@pthr.Mode", "documentation/panther/intrinsics/builtin_module_pthr.html#Mode", "", ["@pthr.mode"], [0,4]),
	new SearchTarget("@pthr.CompilerMode", "documentation/panther/intrinsics/builtin_module_pthr.html#CompilerMode", "", ["@pthr.compilermode"], [0,4]),
	new SearchTarget("@pthr.WindowsSubsystem", "documentation/panther/intrinsics/builtin_module_pthr.html#WindowsSubsystem", "", ["@pthr.windowssubsystem"], [0,4]),
	new SearchTarget("@pthr.OptMode", "documentation/panther/intrinsics/builtin_module_pthr.html#OptMode", "", ["@pthr.optmode"], [0,4]),
	...
	new SearchTarget("@pthr.Iterable", "documentation/panther/intrinsics/builtin_module_pthr.html#Iterable", "", ["@pthr.iterable"], [0,4]),
	new SearchTarget("@pthr.IterableRT", "documentation/panther/intrinsics/builtin_module_pthr.html#Iterable", "", ["@pthr.iterablert"], [0,4]),
	new SearchTarget("@pthr.IterableRef", "documentation/panther/intrinsics/builtin_module_pthr.html#IterableRef", "", ["@pthr.iterableref"], [0,4]),
	new SearchTarget("@pthr.IterableRefRT", "documentation/panther/intrinsics/builtin_module_pthr.html#IterableRef", "", ["@pthr.iterablerefrt"], [0,4]),
	new SearchTarget("@pthr.IterableMutRef", "documentation/panther/intrinsics/builtin_module_pthr.html#IterableMutRef", "", ["@pthr.iterablemutref"], [0,4]),
	new SearchTarget("@pthr.IterableMutRefRT", "documentation/panther/intrinsics/builtin_module_pthr.html#IterableMutRef", "", ["@pthr.iterablemutrefrt"], [0,4]),
	...
	new SearchTarget("@pthr.Iterator", "documentation/panther/intrinsics/builtin_module_pthr.html#Iterator", "", ["@pthr.iterator"], [0,4]),
	new SearchTarget("@pthr.IteratorRT", "documentation/panther/intrinsics/builtin_module_pthr.html#Iterator", "", ["@pthr.iteratorrt"], [0,4]),
	new SearchTarget("@pthr.MutIterator", "documentation/panther/intrinsics/builtin_module_pthr.html#MutIterator", "", ["@pthr.mutiterator"], [0,4]),
	new SearchTarget("@pthr.MutIteratorRT", "documentation/panther/intrinsics/builtin_module_pthr.html#MutIterator", "", ["@pthr.mutiteratorrt"], [0,4]),
