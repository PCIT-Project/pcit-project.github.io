...
const search_targets = [
	...
	new SearchTarget("@build.PantherBuildConfigOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigOutput", "", ["@build.pantherbuildconfigoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigExecutableOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigExecutableOutput", "", ["@build.pantherbuildconfigexecutableoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigObjectOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigObjectOutput", "", ["@build.pantherbuildconfigobjectoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigAssemblyOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigAssemblyOutput", "", ["@build.pantherbuildconfigassemblyoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigLLVMIROutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigLLVMIROutput", "", ["@build.pantherbuildconfigllvmiroutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigPIROutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigPIROutput", "", ["@build.pantherbuildconfigpiroutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigASTOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigASTOutput", "", ["@build.pantherbuildconfigastoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigTokensOutput", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigTokensOutput", "", ["@build.pantherbuildconfigtokensoutput"], [0,4]),
	new SearchTarget("@build.PantherBuildConfigPackage", "documentation/panther/intrinsics/builtin_module_build.html#PantherBuildConfigPackage", "", ["@build.pantherbuildconfigpackage"], [0,4]),
