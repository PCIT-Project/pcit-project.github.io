...
page.paragraph(`There is a GitHub repository that contains the scripts required to download the LLVM Project source code and build it. The script for Windows systems can be found ${html.link("here", "https://github.com/PCIT-Project/llvm-project-build/blob/main/build_llvm.windows.bat")}, and the script for Unix systems can be found ${html.link("here", "https://github.com/PCIT-Project/llvm-project-build/blob/main/build_llvm.unix.sh")}. Get the correct script for your machine, and put it in the directory you created in ${html.link("step 1", "/site/build.html#llvm_1")}.`);
