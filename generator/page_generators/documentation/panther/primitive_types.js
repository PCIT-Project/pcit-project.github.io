...
page.table([
	["Type", "Description"],
	[page.inline_code(Language.PANTHER, "I32"), "32-bit signed integer"],
	[page.inline_code(Language.PANTHER, "UI64"), "64-bit unsigned integer"],
	[page.inline_code(Language.PANTHER, "I1"), "1-bit signed integer"],
	[page.inline_code(Language.PANTHER, "UI46824"), "46,824-bit unsigned integer"],
])

page.h3Searchable("Target-Dependent Integral Types", "target_integral");
page.table([
	["Type", "Description"],
	[page.inline_code(Language.PANTHER, "Int"), "Signed integer that has the same width of a general register on the target (64 on x86_64)"],
	[page.inline_code(Language.PANTHER, "UInt"), "Unsigned integer that has the same width of a general register on the target (64 on x86_64)"],
	[page.inline_code(Language.PANTHER, "ISize"), "Signed integer that has the same width of a pointer on the target (64 on x86_64)"],
	[page.inline_code(Language.PANTHER, "USize"), "Unsigned integer that has the same width of a pointer on the target (64 on x86_64)"],
]);
...
page.table([
	["Type", "C/C++ equivalent"],
	[page.inline_code(Language.PANTHER, "CWChar"), page.inline_code(Language.C, "wchar_t")],
	[page.inline_code(Language.PANTHER, "CShort"), page.inline_code(Language.C, "short")],
	[page.inline_code(Language.PANTHER, "CUShort"), page.inline_code(Language.C, "unsigned short")],
	[page.inline_code(Language.PANTHER, "CInt"), page.inline_code(Language.C, "int")],
	[page.inline_code(Language.PANTHER, "CUInt"), page.inline_code(Language.C, "unsigned int")],
	[page.inline_code(Language.PANTHER, "CLong"), page.inline_code(Language.C, "long")],
	[page.inline_code(Language.PANTHER, "CULong"), page.inline_code(Language.C, "unsigned long")],
	[page.inline_code(Language.PANTHER, "CLongLong"), page.inline_code(Language.C, "long long")],
	[page.inline_code(Language.PANTHER, "CULongLong"), page.inline_code(Language.C, "unsigned long long")],
]);
...
page.table([
	["Type", "Description"],
	[page.inline_code(Language.PANTHER, "F16"), "16-bit floating point (IEEE-754 binary16)"],
	[page.inline_code(Language.PANTHER, "BF16"), "16-bit floating point (bfloat16)"],
	[page.inline_code(Language.PANTHER, "F32"), "32-bit floating point (IEEE-754 binary32)"],
	[page.inline_code(Language.PANTHER, "F64"), "64-bit floating point (IEEE-754 binary64)"],
	[page.inline_code(Language.PANTHER, "F80"), "80-bit floating point (x87)"],
	[page.inline_code(Language.PANTHER, "F128"), "128-bit floating point (IEEE-754 binary128)"],
	[page.inline_code(Language.PANTHER, "CLongDouble"), "C/C++ compatibility type for " + page.inline_code(Language.C, "long double")],
]);
...
page.table([
	["Type", "Description"],
	[page.inline_code(Language.PANTHER, "Void"), `Nothing (for example, to signify that a ${terms.get("function")} returns nothing)`],
	[page.inline_code(Language.PANTHER, "Byte"), "A single byte"],
	[page.inline_code(Language.PANTHER, "Bool"), `Boolean type (${page.inline_code(Language.PANTHER, "true")} or ${page.inline_code(Language.PANTHER, "false")})`],
	[page.inline_code(Language.PANTHER, "Char"), "ASCII Character"],
	[page.inline_code(Language.PANTHER, "RawPtr"), `Opaque pointer type (like ${page.inline_code(Language.C, "void*")} in C/C++)`],
	[page.inline_code(Language.PANTHER, "TypeID"), "Type that represents the unique ID of a type (value not guaranteed to be consistent between compiles)"],
]);
