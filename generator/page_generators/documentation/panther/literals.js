...
page.anchor("integer-literal");
page.h2("Integer Literals");
...
page.anchor("float-literal");
page.h2("Float Literals");
...
page.text(`Float literals may optionally be broken up by underscores ( ${html.inline_code('_')} ) anywhere except for the beginning. This means that ${html.inline_code(syntax_highlighting.panther("1_234.5"))} is equivalent to ${html.inline_code(syntax_highlighting.panther("1.2345"))}.`);



page.anchor("boolean-literals");
page.h2("Boolean Literals");
...
page.anchor("character-literals");
page.h2("Character Literals");
...
page.anchor("string-literals");
page.h2("String Literals");
