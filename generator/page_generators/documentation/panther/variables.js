...
page.table([
	...
	[`in a function that does ${html.italic("not")} have ${terms.get("attribute #runtime")}`, terms.get("comptime"), terms.get("comptime")],
	[`in a function that has ${terms.get("attribute #runtime")}`, terms.get("runtime"), terms.get("runtime")],
]);
