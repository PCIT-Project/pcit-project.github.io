	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/add.html",
				title               : "@add",
				...
				on_site_description : "Integer addition",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @add = <{T: Type, MAY_WRAP: Bool}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Integer addition.`);
			...
			page.addSymbolTemplateParams([
				...
				new Page.TemplateParam("MAY_WRAP", `If ${page.inlineCode("true")}, addition is alowed to wrap`),
			]);
			...
			page.addSymbolSeeAlso(["@addWrap", "@addWrap", "@fadd"]);
		}
	);
}
