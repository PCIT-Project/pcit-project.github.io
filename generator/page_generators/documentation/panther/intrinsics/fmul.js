	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/fmul.html",
				title               : "@fmul",
				...
				on_site_description : "Floating-point multiplication",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @fmul = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Floating-point multiplication.`);
			...
			page.addSymbolSeeAlso(["@mul", "@mulWrap", "@mulSat"]);
		}
	);
}
