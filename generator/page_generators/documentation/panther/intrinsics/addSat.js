	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/addSat.html",
				title               : "@addSat",
				...
				on_site_description : "Integer saturating addition",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @addSat = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Integer saturating addition.`);
			...
			page.addSymbolSeeAlso(["@add", "@addWrap", "@fadd"]);
		}
	);
}
