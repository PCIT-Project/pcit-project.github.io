	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/and.html",
				title               : "@and",
				...
				on_site_description : "Bitwise and",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @and = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Bitwise and.`);
			...
			page.addSymbolReturn("Result value of the bitwise and");


			page.addSymbolExampleTodo();

			page.addSymbolSeeAlso(["@or", "@xor"]);
		}
	);
}
