...
page.text(page.inline_code(Language.PANTHER, "func @add = <{T: Type, MAY_WRAP: Bool}> (lhs: T, rhs: T) -> T;"));
page.text(`Integer addition. ${html.inline_code("T")} must be ${terms.get("integral")} or a ${terms.get("vector")} of ${terms.get("integral")}.`);
page.text(`Wrapping when ${html.inline_code("MAY_WRAP")} is ${page.inline_code(Language.PANTHER, "false")} is ${terms.get("undefined behavior")}.`);

page.h2Searchable("@addWrap", "addWrap");
page.text(page.inline_code(Language.PANTHER, "func @addWrap = <{T: Type}> (lhs: T, rhs: T) -> (result: T, wrapped: Bool);"));
page.text(`Integer addition where ${html.inline_code("wrapped")} is ${page.inline_code(Language.PANTHER, "true")} if wrapping occured. ${html.inline_code("T")} must be ${terms.get("integral")} or a ${terms.get("vector")} of ${terms.get("integral")}.`);

page.h2Searchable("@addSat", "addSat");
page.text(page.inline_code(Language.PANTHER, "func @addSat = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @fadd = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @sub = <{T: Type, MAY_WRAP: Bool}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @subWrap = <{T: Type}> (lhs: T, rhs: T) -> (result: T, wrapped: Bool);"));
page.text(`Integer subtraction where ${html.inline_code("wrapped")} is ${page.inline_code(Language.PANTHER, "true")} if wrapping occured. ${html.inline_code("T")} must be ${terms.get("integral")} or a ${terms.get("vector")} of ${terms.get("integral")}.`);

page.h2Searchable("@subSat", "subSat");
page.text(page.inline_code(Language.PANTHER, "func @subSat = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @fsub = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @mul = <{T: Type, MAY_WRAP: Bool}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @mulWrap = <{T: Type}> (lhs: T, rhs: T) -> (result: T, wrapped: Bool);"));
page.text(`Integer multiplication where ${html.inline_code("wrapped")} is ${page.inline_code(Language.PANTHER, "true")} if wrapping occured. ${html.inline_code("T")} must be ${terms.get("integral")} or a ${terms.get("vector")} of ${terms.get("integral")}.`);

page.h2Searchable("@mulSat", "mulSat");
page.text(page.inline_code(Language.PANTHER, "func @mulSat = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @fmul = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @div = <{T: Type, IS_EXACT: Bool}> (lhs: T, rhs: T) -> T;"));
page.text(`Integer division. ${html.inline_code("T")} must be ${terms.get("integral")} or a ${terms.get("vector")} of ${terms.get("integral")}.`);
page.text(`If ${html.inline_code("IS_EXACT")} is ${page.inline_code(Language.PANTHER, "true")}, it is ${terms.get("undefined behavior")} if ${page.inline_code(Language.PANTHER, "(@div<{TYPE, true}>(a, b) * b) != a")}.`);

page.h2Searchable("@fdiv", "fdiv");
page.text(page.inline_code(Language.PANTHER, "func @fdiv = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @rem = <{T: Type}> (lhs: T, rhs: T) -> T;"));
...
page.text(page.inline_code(Language.PANTHER, "func @fneg = <{T: Type}> (arg: T) -> T;"));
