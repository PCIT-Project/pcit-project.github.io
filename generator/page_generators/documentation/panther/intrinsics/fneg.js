	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/fneg.html",
				title               : "@fneg",
				...
				on_site_description : "Floating-point negation",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @fneg = <{T: Type}> (arg: T) -> T;"]);

			page.addSymbolDescription(`Floating-point negation.`);
			...
			page.addSymbolParams([
				new Page.Param("arg", "value to be negated"),
			]);


			page.addSymbolReturn("Result value of the negation");
