	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/sub.html",
				title               : "@sub",
				...
				on_site_description : "Integer subtraction",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @sub = <{T: Type, MAY_WRAP: Bool}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Integer subtraction.`);
			...
			page.addSymbolTemplateParams([
				...
				new Page.TemplateParam("MAY_WRAP", `If ${page.inlineCode("true")}, subtraction is alowed to wrap`),
			]);
			...
			page.addSymbolSeeAlso(["@subWrap", "@subWrap", "@fsub"]);
		}
	);
}
