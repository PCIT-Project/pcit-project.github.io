	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/div.html",
				title               : "@div",
				...
				on_site_description : "Integer division",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @div = <{T: Type, IS_EXACT: Bool}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Integer division.`);
			...
			page.addSymbolTemplateParams([
				...
				new Page.TemplateParam("IS_EXACT", `If ${page.inlineCode("true")}, guarantees that the result never has a remainder`),
			]);
			...
			page.addSymbolSeeAlso(["@fdiv", "@rem"]);
		}
	);
}
