	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/fdiv.html",
				title               : "@fdiv",
				...
				on_site_description : "Floating-point division",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @fdiv = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Floating-point division.`);
