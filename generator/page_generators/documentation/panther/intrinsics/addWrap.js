	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/addWrap.html",
				title               : "@addWrap",
				...
				on_site_description : "Integer addition that returns if operation wrapped",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @addWrap = <{T: Type}> (lhs: T, rhs: T) -> (result: T, wrapped: Bool);"]);

			page.addSymbolDescription(`Integer addition that returns if operation wrapped.`);
			...
			page.addSymbolReturnParams([
				new Page.ReturnParam("result", "result of the addition"),
			...
			page.addSymbolSeeAlso(["@add", "@addSat", "@fadd"]);
		}
	);
}
