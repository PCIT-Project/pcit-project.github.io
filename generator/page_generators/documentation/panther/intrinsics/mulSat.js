	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/mulSat.html",
				title               : "@mulSat",
				...
				on_site_description : "Integer saturating multiplication",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @mulSat = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Integer saturating multiplication.`);
			...
			page.addSymbolSeeAlso(["@mul", "@mulWrap", "@fmul"]);
		}
	);
}
