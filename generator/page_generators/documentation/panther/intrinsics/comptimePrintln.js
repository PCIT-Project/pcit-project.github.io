	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/comptimePrintln.html",
				title               : "@comptimePrintln",
		...
		(page) => {
			page.addSymbolDecls(["func @comptimePrintln = (str: [Char:*]) #ct -> Void;"]);

			page.addSymbolDescription("Print to console at compile time. A newline character is automatically appended.");
			...
			page.addSymbolSeeAlso(["@comptimePrint"]);
		}
	);
}
