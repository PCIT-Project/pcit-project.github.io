	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/iToF.html",
				title               : "@iToF",
				...
				on_site_description : `Convert any ${terms.get("integral")} type to any ${terms.get("floating-point")} type`,
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @iToF = <{FROM: Type, TO: Type}> (from: FROM) -> TO;"]);

			page.addSymbolDescription(`Convert any ${terms.get("integral")} type to any ${terms.get("floating-point")} type`);
