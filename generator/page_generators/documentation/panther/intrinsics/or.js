	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/or.html",
				title               : "@or",
				...
				on_site_description : "Bitwise or",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @or = <{T: Type}> (lhs: T, rhs: T) -> T;"]);

			page.addSymbolDescription(`Bitwise or.`);
			...
			page.addSymbolReturn("Result value of the bitwise or");


			page.addSymbolExampleTodo();

			page.addSymbolSeeAlso(["@and", "@xor"]);
		}
	);
}
