	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/fToI.html",
				title               : "@fToI",
				...
				on_site_description : `Convert any ${terms.get("floating-point")} type to any ${terms.get("integral")} type`,
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @fToI = <{FROM: Type, TO: Type}> (from: FROM) -> TO;"]);

			page.addSymbolDescription(`Convert any ${terms.get("floating-point")} type to any ${terms.get("integral")} type`);
