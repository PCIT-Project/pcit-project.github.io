	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/eq.html",
				title               : "@eq",
				...
				on_site_description : "Calculate equality",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @eq = <{T: Type}> (lhs: T, rhs: T) -> Bool;"]);

			page.addSymbolDescription(`Calculate equality.`);
			...
			page.addSymbolReturn(`Returns ${page.inlineCode("true")} if values are equal`);


			page.addSymbolExampleTodo();

			page.addSymbolSeeAlso(["@neq"]);
		}
	);
}
