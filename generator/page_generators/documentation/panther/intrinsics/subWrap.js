	...
	return new (require("../../../../PageGenerator.js").PageGenerator)(
		() => {
			return new Page.Page(__filename, {
				path                : "documentation/panther/intrinsics/subWrap.html",
				title               : "@subWrap",
				...
				on_site_description : "Integer subtraction that returns if operation wrapped",
				symbol_kind         : Page.SymbolKind.INTRINSIC_FUNCTION,
			})
		},
		(page) => {
			page.addSymbolDecls(["func @subWrap = <{T: Type}> (lhs: T, rhs: T) -> (result: T, wrapped: Bool);"]);

			page.addSymbolDescription(`Integer subtraction that returns if operation wrapped.`);
			...
			page.addSymbolReturnParams([
				new Page.ReturnParam("result", "result of the subtraction"),
			...
			page.addSymbolSeeAlso(["@sub", "@subSat", "@fsub"]);
		}
	);
}
